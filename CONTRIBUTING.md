...
│   ├── languageIcons.tsx         # Icon utilities, mappings, and color adjustment
│   └── LanguageTabs.tsx          # LanguageTabs and LanguageTab components
├── website/                      # Documentation website
│   ├── docs/                     # Website documentation
│   │   ├── index.mdx             # Homepage
│   │   └── examples.mdx          # Comprehensive examples
│   ├── doc_build/                # Built website (git-ignored)
│   ├── rspress.config.ts         # Website config
│   └── package.json              # Website dependencies
├── .github/workflows/            # CI/CD pipelines
│   ├── build.yaml                # Build, lint, and validation checks
